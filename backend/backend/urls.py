...
urlpatterns = [
    ...
    path('api/courses/<int:pk>/', CourseView.as_view({"patch": "partial_update","delete": "destroy"}), name='course'),
    path('api/courses/', CourseView.as_view({"get": "list","post": "create"}), name='course'),
